...
//Purpose: Updates and improves a previously created lab that creates an interactive guessing game to play with a user.
...
public class Lab1 {
   ...
   public static void results(double gameCount, double guessCount, int bestGuess) {
      double avgGame = guessCount / gameCount;
         if(gameCount == 0) {
            System.out.println("Okay, see you next time then!:)");
         }
         else {
